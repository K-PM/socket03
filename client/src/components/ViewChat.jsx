...
import logoimagewpic from "../assets/img/image.png"
...
function ViewChat() {
    ...
    return ( 
    <>  
        <form onSubmit={handleSubmit} className=" w-full h-full p-11">
          ...
          <h1 className="text-2x1 font-bold my-2 mx-2">Selecciono a : {conversation.to.username}</h1>
        </form>
    </> 
    );
}
